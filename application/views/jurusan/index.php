<div class="container">
    <legend> Type Buku</legend>
    <a class="btn btn-primary" href="<?= base_url('jurusan/tambah'); ?>" role="button">Tambah Type</a>
    <?php if( $this->session->flashdata('flash') ): ?>
        <div class="alert alert-success alert-dismissible fade show mt-2 mb-2" role="alert">
            Data Type Buku <strong>berhasil!!!</strong> <?= $this->session->flashdata('flash'); ?>
